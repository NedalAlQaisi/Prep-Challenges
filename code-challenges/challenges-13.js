...
const stringReverse = (str) => {
    ...
    const theWords = str.split(" ");

    const reversedWord = theWords.reduce((reversed, word) => {
...
const statistics = (obj) => {
    ...
    const result = obj.reduce((acc, vote) => {

        return {...acc, [vote.votes_To]: (acc[vote.votes_To] || 0) + 1 };
