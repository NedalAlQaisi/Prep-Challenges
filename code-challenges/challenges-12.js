...
const vowelsFiltration = (arr) => {
    ...
    const no_Vowels = arr.filter(words => {

        return !words.match(/[aeiou]/g);
    })
...
const skillComparison = (arr1, arr2) => {
    ...
    const skill1 = arr2.filter(x => !arr1.includes(x));
    const skill2 = arr1.filter(x => !arr2.includes(x));
